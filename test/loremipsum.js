module.exports = function div(h) {
	return h(
		"div",
		{ "className": "page-wrapper" },
		h(
			"section",
			{ "className": "intro", id: "zen-intro" },
			h(
				"header",
				{ role: "banner" },
				h(
			...
			h(
				"div",
				{ "className": "summary", id: "zen-summary", role: "article" },
				h(
					"p",
					null,
				...
				h(
					...
					h(
						"a",
						{ href: "/examples/style.css", title: "This page's sample CSS, the file you may modify." },
						"css file"
					)
				)
			),
			h(
				"div",
				{ "className": "preamble", id: "zen-preamble", role: "article" },
				h(
					"h3",
					null,
		...
		h(
			"div",
			{ "className": "main supporting", id: "zen-supporting", role: "main" },
			h(
				"div",
				{ "className": "explanation", id: "zen-explanation", role: "article" },
				h(
					"h3",
					null,
			...
			h(
				"div",
				{ "className": "participation", id: "zen-participation", role: "article" },
				h(
					"h3",
					null,
					"Participation"
				...
				h(
					...
					h(
						"a",
						{ href: "http://www.mezzoblue.com/zengarden/resources/", title: "A listing of CSS-related resources" },
						h(
							"abbr",
							{ title: "Cascading Style Sheets" },
							"CSS"
				...
				h(
					...
					h(
						"a",
						{ href: "http://www.mezzoblue.com/zengarden/submit/", title: "Use the contact form to send us your CSS file" },
						"Send us a link"
					),
			...
			h(
				"div",
				{ "className": "benefits", id: "zen-benefits", role: "article" },
				h(
					"h3",
					null,
					"Benefits"
			...
			h(
				"div",
				{ "className": "requirements", id: "zen-requirements", role: "article" },
				h(
					"h3",
					null,
					"Requirements"
				...
				h(
					...
					h(
						"abbr",
						{ title: "Cascading Style Sheets, levels 1 and 2" },
						"CSS 1 & 2"
					),
					" usage. ",
					h(
						"abbr",
						{ title: "Cascading Style Sheets, levels 3 and 4" },
						"CSS 3 & 4"
					),
				...
				h(
					...
					h(
						"a",
						{ href: "http://creativecommons.org/licenses/by-nc-sa/3.0/", title: "View the Zen Garden's license information." },
						"one on this site"
					),
			...
			h(
				...
				h(
					"a",
					{ href: "http://validator.w3.org/check/referer", title: "Check the validity of this site\u2019s HTML", "className": "zen-validate-html" },
					"HTML"
				),
				h(
					"a",
					{ href: "http://jigsaw.w3.org/css-validator/check/referer", title: "Check the validity of this site\u2019s CSS", "className": "zen-validate-css" },
					"CSS"
				),
				h(
					"a",
					{ href: "http://creativecommons.org/licenses/by-nc-sa/3.0/", title: "View the Creative Commons license of this site: Attribution-NonCommercial-ShareAlike.", "className": "zen-license" },
					"CC"
				),
				h(
					"a",
					{ href: "http://mezzoblue.com/zengarden/faq/#aaa", title: "Read about the accessibility of this site", "className": "zen-accessibility" },
					"A11y"
				),
				h(
					"a",
					{ href: "https://github.com/mezzoblue/csszengarden.com", title: "Fork this site on Github", "className": "zen-github" },
					"GH"
				)
			)
		),
		h(
			...
			h(
				...
				h(
					"div",
					{ "className": "design-selection", id: "design-selection" },
					h(
						"h3",
						{ "className": "select" },
						"Select a Design:"
					...
					h(
						...
						h(
							...
							h(
								...
								h(
									"a",
									{ href: "/221/", "className": "design-name" },
									"Mid Century Modern"
								),
								" by      ",
								h(
									"a",
									{ href: "http://andrewlohman.com/", "className": "designer-name" },
									"Andrew Lohman"
								)
							),
							"     ",
							h(
								...
								h(
									"a",
									{ href: "/220/", "className": "design-name" },
									"Garments"
								),
								" by      ",
								h(
									"a",
									{ href: "http://danielmall.com/", "className": "designer-name" },
									"Dan Mall"
								)
							),
							"     ",
							h(
								...
								h(
									"a",
									{ href: "/219/", "className": "design-name" },
									"Steel"
								),
								" by      ",
								h(
									"a",
									{ href: "http://steffen-knoeller.de", "className": "designer-name" },
									"Steffen Knoeller"
								)
							),
							"     ",
							h(
								...
								h(
									"a",
									{ href: "/218/", "className": "design-name" },
									"Apothecary"
								),
								" by      ",
								h(
									"a",
									{ href: "http://trentwalton.com", "className": "designer-name" },
									"Trent Walton"
								)
							),
							"     ",
							h(
								...
								h(
									"a",
									{ href: "/217/", "className": "design-name" },
									"Screen Filler"
								),
								" by      ",
								h(
									"a",
									{ href: "http://elliotjaystocks.com/", "className": "designer-name" },
									"Elliot Jay Stocks"
								)
							),
							"     ",
							h(
								...
								h(
									"a",
									{ href: "/216/", "className": "design-name" },
									"Fountain Kiss"
								),
								" by      ",
								h(
									"a",
									{ href: "http://jeremycarlson.com", "className": "designer-name" },
									"Jeremy Carlson"
								)
							),
							"     ",
							h(
								...
								h(
									"a",
									{ href: "/215/", "className": "design-name" },
									"A Robot Named Jimmy"
								),
								" by      ",
								h(
									"a",
									{ href: "http://meltmedia.com/", "className": "designer-name" },
									"meltmedia"
								)
							),
							"     ",
							h(
								...
								h(
									"a",
									{ href: "/214/", "className": "design-name" },
									"Verde Moderna"
								),
								" by      ",
								h(
									"a",
									{ href: "http://www.mezzoblue.com/", "className": "designer-name" },
									"Dave Shea"
								)
							),
							"     "
				...
				h(
					"div",
					{ "className": "design-archives", id: "design-archives" },
					h(
						"h3",
						{ "className": "archives" },
						"Archives:"
					...
					h(
						...
						h(
							...
							h(
								...
								h(
									"a",
									{ href: "http://www.mezzoblue.com/zengarden/alldesigns/", title: "View every submission to the Zen Garden." },
									"View All Designs       "
								)
							)
						)
				...
				h(
					"div",
					{ "className": "zen-resources", id: "zen-resources" },
					h(
						"h3",
						{ "className": "resources" },
						"Resources:"
					...
					h(
						...
						h(
							...
							h(
								"a",
								{ href: "/214/214.css", title: "View the source CSS file of the currently-viewed design." },
								"View This Design\u2019s ",
								h(
									"abbr",
									{ title: "Cascading Style Sheets" },
						...
						h(
							...
							h(
								"a",
								{ href: "http://www.mezzoblue.com/zengarden/resources/", title: "Links to great sites with information on using CSS." },
								h(
									"abbr",
									{ title: "Cascading Style Sheets" },
									"CSS"
						...
						h(
							...
							h(
								"a",
								{ href: "http://www.mezzoblue.com/zengarden/faq/", title: "A list of Frequently Asked Questions about the Zen Garden." },
								h(
									"abbr",
						...
						h(
							...
							h(
								"a",
								{ href: "http://www.mezzoblue.com/zengarden/submit/", title: "Send in your own CSS file." },
								"Submit a Design      "
							)
						),
						h(
							"li",
							{ "className": "zen-translations" },
							h(
								"a",
								{ href: "http://www.mezzoblue.com/zengarden/translations/", title: "View translated versions of this page." },
								"Translations      "
							)
						)
					)
